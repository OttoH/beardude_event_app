...
export const actionCreators = {
  accountInfo: () => async (dispatch, getState) => {
    try {
      const response = await fetch(`${SERVICE_URL}/api/manager/account`, {credentials: 'same-origin'})
  ...
  login: () => async (dispatch, getState) => {
    ...
    try {
      const response = await fetch(`${SERVICE_URL}/api/manager/login`, fetchObject)
      const res = await response.json()
  ...
  logout: () => async (dispatch, getState) => {
    try {
      const response = await fetch(`${SERVICE_URL}/api/manager/logout`, {credentials: 'same-origin'})
      const res = await response.json()
